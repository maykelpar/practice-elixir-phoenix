    ...
    <div class="max-w-7xl mx-auto mt-40 text-gray-300 text-4xl items-center h-screen">
      <div class="grid grid-cols-2 justify-center items-center space-x-52">
        ...
        <div class="mt-36 space-x-6">
          <.link navigate="/parent-login" class="text-lg border rounded-lg px-6 py-2 hover hover:bg-blue-100 hover:text-black"> Guardian Login </.link>
          <.link navigate="/user" class="text-lg border rounded-lg px-6 py-2 hover hover:bg-blue-100 hover:text-black"> Admin Login </.link>
